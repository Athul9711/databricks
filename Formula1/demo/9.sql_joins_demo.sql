...
--LEFT JOIN(NULL IN RIGHT--COMMON)
...
--RIGHT JOIN/RIGHT OUTER JOIN(NULL IN LEFT)
...
--FULL JOIN/FULL OUTER JOIN:SUPERSET OF BOTH LEFT AND RIGHT JOINS
...
--SEMI JOIN :INNER JOIN WITH ONLY LEFT TABLE DATA
...
--CARTESIAN PRODUCT OF TWO TABLES(20*24)
